      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 opacity-0 animate-[fade-in_0.5s_ease-out_0.5s_forwards]">
          <Alert variant="default" className="bg-blue-50 border-blue-200">
            ...
            <AlertTitle>About this map</AlertTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className={`space-y-6 ${showInfo ? 'opacity-100 transition-opacity duration-700' : 'opacity-0'}`}>
            <Card className="p-4 border-gray-100 bg-gradient-to-b from-white to-gray-50">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-green-500"></div>
                  <span className="text-sm">Below 60 dB - Safe levels</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-yellow-500"></div>
                  <span className="text-sm">60-80 dB - Moderate levels</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-red-500"></div>
                  <span className="text-sm">Above 80 dB - High levels</span>
                </div>
                <div className="flex items-center gap-2">
